...
export class GoldSkyBackend extends MessageBackend {
   ...
   * @param environment name of the environment as string
   * @param context ZeroBridge context to be used with the backend
   * @returns
   */
  static default(
   ...
   */
  get uri(): string {
    // return `https://${this.env}.goldsky.io/c/zerobridge/gql/v1/graphql`
    return `https://api.goldsky.io/c/zerobridge/gql/v1/graphql`;
  }
