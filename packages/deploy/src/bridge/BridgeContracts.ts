import * as contracts from '@zerobridge-xyz/contracts-bridge';
import {
  UBP_SPECIFIER,
...
} from '@zerobridge-xyz/contracts-core';

import { ethers } from 'ethers';
import { utils } from '@zerobridge-xyz/multi-provider';
import * as config from '@zerobridge-xyz/configuration';

import Contracts from '../Contracts';
import { DeployContext } from '../DeployContext';
import { log } from '../utils';
import { Call, CallBatch } from '@zerobridge-xyz/sdk-govern';
