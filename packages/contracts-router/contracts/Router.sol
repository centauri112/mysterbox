...
// ============ External Imports ============
import {IMessageRecipient} from "@zerobridge-xyz/contracts-core/contracts/interfaces/IMessageRecipient.sol";
...
abstract contract Router is XAppConnectionClient, IMessageRecipient {
     ...
     */
    function _mustHaveRemote(
        uint32 _domain
    ) internal view returns (bytes32 _remote) {
