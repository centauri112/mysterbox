...
contract ETHHelper {
    ...
    /**
     * @notice Sends ETH over the ZeroBridge Bridge. Sends to a full-width ZeroBridge
    ...
    /**
     * @notice Sends ETH over the ZeroBridge Bridge. Sends to the same address on
     * the other side.
    ...
    /**
     * @notice Sends ETH over the ZeroBridge Bridge. Sends to a specified EVM
