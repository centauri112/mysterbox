...
import {Router} from "@zerobridge-xyz/contracts-router/contracts/Router.sol";
...
import {Version0} from "@zerobridge-xyz/contracts-core/contracts/Version0.sol";
...
abstract contract BaseBridgeRouter is Version0, Router {
    ...
    function _takeTokens(
        address _token,
        uint256 _amount
    ) internal returns (bytes29 _tokenId, bytes32 _detailsHash) {
    ...
    /**
     * @notice Dispatch a message via ZeroBridge to a destination domain
    ...
    function _sendTransferMessage(
        ...
        // send message to remote chain via ZeroBridge
