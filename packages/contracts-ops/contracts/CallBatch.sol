...
import {GovernanceMessage} from "@zerobridge-xyz/contracts-core/contracts/governance/GovernanceMessage.sol";
...
abstract contract CallBatch {
    ...
    function pushRemote(address to, bytes memory data, uint32 domain) public {
    ...
    function prankExecuteGovernor(address router) public {
        ...
        // NOTE: remote calls will be sent as ZeroBridge message
