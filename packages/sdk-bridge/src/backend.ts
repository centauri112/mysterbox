import { GoldSkyBackend, GoldSkyMessage, MessageFilter, MessageBackend } from '@zerobridge-xyz/sdk';
import { request, gql } from 'graphql-request';
import * as config from '@zerobridge-xyz/configuration';
import { BridgeContext } from './BridgeContext';
import { nulls2undefined } from '@zerobridge-xyz/sdk/src/messageBackend/utils';
